...
public class DropMaterializedView extends SchemaCommand {
    ...
    public DropMaterializedView(Session session, Schema schema) {
        ...
        if (view == null) {
            ...
            if (dropAction == ConstraintActionType.RESTRICT) {
                for (DbObject child : view.getChildren()) {
                    if (child instanceof TableMaterializedView) {
            ...
            TableMaterializedView tableView = (TableMaterializedView) view;
            ...
            for (Table childTable: copyOfDependencies) {
                if (TableType.VIEW == childTable.getTableType()) {
                    TableMaterializedView childTableView = (TableMaterializedView) childTable;
