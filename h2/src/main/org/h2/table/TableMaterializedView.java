...
public class TableMaterializedView extends Table {
     ...
     * @return the view
     */
    public static TableMaterializedView createTableViewMaybeRecursive(Schema schema, int id, String name, String querySQL,
        ...
        try {
            ...
            columnTemplateList = TableMaterializedView.createQueryColumnTemplateList(columnNames.toArray(new String[1]),
        ...
        TableMaterializedView view = new TableMaterializedView(schema, id, name, querySQL,
        ...
        if (!view.isRecursiveQueryDetected()) {
            ...
            view = new TableMaterializedView(schema, id, name, querySQL, parameters,
